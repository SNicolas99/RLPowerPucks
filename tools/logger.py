...
class Logger:
    ...
    def plot(self):
        ...
        if test_rewards.size == 0:
            ...
            plt.plot(
                test_episodes,
                savgol_filter(test_rewards, 10, 3, axis=0),
                label="test reward",
            )
        ...
        if self.hockey:
            if winrate.size < 51:
                ...
                plt.plot(
                    hockey_episodes,
                    savgol_filter(winrate, 51, 3, axis=0),
                    label="winrate",
                )
                plt.plot(
                    hockey_episodes,
                    savgol_filter(lossrate, 51, 3, axis=0),
                    label="lossrate",
                )
        ...
        plt.plot(
            savgol_filter(self.train_durations, 51, 3, axis=0),
            label="avg. train durations",
        )
